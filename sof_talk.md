...
Specifically, my current research is on the ways people imagine what can be done with a given technology, the way in which, for instance, a user picks up a tool and thinks through either its practical limitations or what can be done with it that wasn't possible before.
...
To take the bookends in the title of my talk, originally, *gadget* refered to something like this -- the marlinspike, a curved piece of bone or wood used to splice ropes and undo knots.  As a term of nauical jargon, "gadget" refered to anything that had been…, and there's a lot of wonderful material in nautical handbooks debating terminology -- whether the gadget is the tool used to perform an action, or the technique of performing that action itself, etc etc.
...
Writing on the effect of “wonder,” Tom Gunning argues that “wonder draws our attention to new technology, not simply as a tool, but precisely as a spectacle, less as something that performs a useful task than as something which astounds us by performing in a way that seemed unlikely or magical before.”  
